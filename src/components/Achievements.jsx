    ...
    <div className="text-white min-h-screen flex justify-between items-top px-6 py-10">
      <div className="basis-1/4 text-center mb-12">
        <span className="inline-flex uppercase font-bold tracking-wider text-gray-400 mb-2">
          <IconPoint className="text-white -ml-40" stroke={5} width={20} />
          Achievements
        </span>
      ...
      <div className="grid grid-cols-2 gap-10 basis-2/3 w-full max-w-5xl">
        <div className="service-boxtwo max-h-64 bg-gray-800 rounded-lg border border-gray-700 hover:border-purple-900 hover:bg-gradient-to-r hover:from-purple-800 hover:via-purple-700 hover:to-purple-500 transition duration-300">
        ...
        <div className="service-boxtwo max-h-64 -mt-20 bg-gray-800 rounded-lg border border-gray-700 hover:border-purple-900 hover:bg-gradient-to-r hover:from-purple-800 hover:via-purple-700 hover:to-purple-500 transition duration-300">
          <div className="service-order relative text-gray-200 text-2xl font-extrabold">
