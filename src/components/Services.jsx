  ...
  return (
    ...
    >
      ...
      <div className="block basis-2/3 w-full max-w-5xl">
        <div className="service-box mb-10 bg-gray-800 rounded-lg border border-gray-700 hover:border-purple-900/5 hover:bg-gradient-to-r hover:from-purple-800/5 hover:via-purple-700/5 hover:to-purple-500/5 transition duration-300">
